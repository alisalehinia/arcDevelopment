...
export default function Websites({ setValue, setSelectedIndex }) {
    ...
    return (
        <Grid container direction="column">
            <Grid item container direction={matchesSM ? "column" : "row"} className={classes.rowContainer} style={{ marginTop: matchesXS ? "1em" : "2em" }} justify={matchesMD ? "center" : undefined}>
                <Hidden mdDown>
                    <Grid item className={classes.arrowContainer} style={{ marginRight: "1em", marginLeft: "-3.5em" }}>
                        <IconButton onClick={() => setSelectedIndex(3)} component={Link} to="/mobileapps" style={{ backgroundColor: "transparent" }} >
                ...
                <Hidden mdDown>
                    <Grid item className={classes.arrowContainer}>
                        <IconButton onClick={() => setSelectedIndex(0)} component={Link} to="/services" style={{ backgroundColor: "transparent" }}>
                            <img src={forwardArrow} alt="Forward to services page" />
                        </IconButton>
                    </Grid>
                </Hidden>
            </Grid>
            <Grid item container direction={matchesSM ? "column" : "row"} style={{ marginTop: "15em" }} className={classes.rowContainer} alignItems="center">
                <Grid item>
                    <Grid container direction="column">
                        <Grid item>
                        ...
                        <Grid item>
                            <img style={{ marginLeft: "-2.75em" }} src={analytics} alt="grab with magnifying glass revealing 1's and '0's" />
                        </Grid>
                    </Grid>
                </Grid>
            ...
            <Grid item container direction={matchesSM ? "column" : "row"} style={{ marginBottom: "15em", marginTop: "15em" }} className={classes.rowContainer} alignItems="center" justify="flex-end">
                <Grid item>
                    <Grid container direction="column">
                        <Grid item>
                        ...
                        <Grid item>
                            <img src={ecommerce} alt="world outline made of $ signs" />
                        </Grid>
                    </Grid>
                </Grid>
                <Grid item style={{ marginLeft: matchesSM ? 0 : "1em" }} className={classes.paragraphContainer}>
                    ...
                    <Typography align={matchesSM ? "center" : undefined} variant="body1" paragraph>
                        IIn 2017 over $2.3 trillion was spent in e-commerce, and it’s time for your slice of that pie.
                    </Typography>
                </Grid>
            </Grid>
            ...
            <Grid item container direction={matchesSM ? "column" : "row"} style={{ marginTop: "15em", marginBottom: "15em" }} className={classes.rowContainer} alignItems="center" justify="flex-end">
                <Grid item>
                    <Grid container direction="column">
                        <Grid item>
                            <Typography align="center" variant="h4" gutterBottom>
