...
export default function CustomSoftware({ setValue, setSelectedIndex }) {
    ...
    return (
        <Grid container direction="column">
            <Grid item container direction="row" className={classes.rowContainer} style={{ marginTop: matchesXS ? "1em" : "2em" }} justify={matchesMD ? "center" : undefined}>
                <Hidden mdDown>
                ...
                <Hidden mdDown>
                    <Grid item className={classes.arrowContainer}>
                        <IconButton onClick={() => setSelectedIndex(2)} component={Link} to="/mobileapps" style={{ backgroundColor: "transparent" }}>
                            <img src={forwardArrow} alt="Forward to Android/ios App Development page" />
                        </IconButton>
                    </Grid>
                </Hidden>
            </Grid>
            ...
            <Grid item container className={classes.rowContainer} direction={matchesMD ? "column" : "row"} alignItems={matchesMD ? "center" : undefined} justify="space-around">
                <Grid item container className={classes.itemContainer} style={{ marginBottom: matchesMD ? "15em" : 0 }}
                ...
                <Grid direction={matchesSM ? "column" : "row"} item container className={classes.itemContainer} md>
                    <Grid item md>
            ...
            <Grid item container className={classes.rowContainer} direction="row" style={{ marginTop: "20em", marginBottom: "20em" }}>
                <Grid item container direction="column" alignItems="center">
                    <Grid item>
                        <img src={roots} alt="tree with roots extending out" height={matchesSM ? "200em" : "450em"} width={matchesSM ? "200em" : "450em"} />
                    </Grid>
            ...
            <Grid item container className={classes.rowContainer} direction={matchesMD ? "column" : "row"} alignItems={matchesMD ? "center" : undefined} justify="space-around" style={{ marginBottom: "20em" }}>
                <Grid item container alignContent={matchesSM ? "center" : undefined} className={classes.itemContainer} direction={matchesSM ? "column" : "row"} style={{ marginBottom: matchesMD ? "15em" : 0 }} md>
                    <Grid item container direction="column" md>
                        <Grid item>
                            <Typography variant="h4" align={matchesSM ? "center" : undefined}>
                                Automation
