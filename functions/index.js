...
exports.sendMail = functions.https.onRequest((request, response) => {
    cors(request, response, () => {
        ...
        mailOptions = {
            ...mailOptions, to: "protonvpn614@gmail.com", subject: "Message received",
            html: `
        ...
        transporter.sendMail(mailOptions, error => {
            if (error) {
                ...
                response.sendMail("message sent successfully")
            }
        })
        mailOptions = {
            ...mailOptions, to: email, subject: "we have received your message",
            html: `
